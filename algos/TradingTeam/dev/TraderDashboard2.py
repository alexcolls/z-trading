...
GSheet = 'Trader'
AccountID = '101-004-10159382-001'
#Token = input("Enter Oanda's API Token: ")
#GSheet = input("Enter Google sheet's name: ")
...
def GlobalVariables():
    global AccountID
    AccountID = Oanda_AccountID()
    global Connected
    Connected = TestOandaConnection(False)
    if Connected:
        global HardStop
...
FirstRun = True
Connected = TestOandaConnection(True)
AccountID = gsAccDsh.cell('C2').value
HardStop = Oanda_HardStop()

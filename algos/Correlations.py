...
def GSapi(GSname,GSsheet):
    ...
    credentials = SAC.from_json_keyfile_name('C:\ZorroBeta\Strategy\TradingTeam\dev\GS_main.json',scope)
...
g = GSapi('OandaEurope','Correlation')

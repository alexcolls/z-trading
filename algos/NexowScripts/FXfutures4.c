...
void run() {
    ...
    ContFutvsSpotCandleAlgo(1,"Algo1","EUR/USD","CHRIS/CME_EC1",1,6,0,1,FALSE);
    ContFutvsSpotCandleAlgo(2,"Algo1b","EUR/USD","CHRIS/CME_EC2",1,6,0,1,FALSE);

    ContFutvsSpotCandleAlgo(3,"Algo2","GBP/USD","CHRIS/CME_BP1",1,6,0,1,FALSE);
    ContFutvsSpotCandleAlgo(4,"Algo2b","GBP/USD","CHRIS/CME_BP2",1,6,0,1,FALSE);

    ContFutvsSpotCandleAlgo(5,"Algo3","USD/CHF","CHRIS/CME_SF1",1,6,1,1,TRUE);
    ContFutvsSpotCandleAlgo(6,"Algo3b","USD/CHF","CHRIS/CME_SF2",1,6,1,1,FALSE);

    ContFutvsSpotCandleAlgo(7,"Algo4","USD/CAD","CHRIS/CME_CD1",1,6,1,1,FALSE);
    ContFutvsSpotCandleAlgo(8,"Algo4b","USD/CAD","CHRIS/CME_CD2",1,6,1,1,FALSE);
    ContFutvsSpotCandleAlgo(9,"Algo4c","USD/CAD","CHRIS/CME_CD3",1,6,1,1,FALSE);

    ContFutvsSpotCandleAlgo(10,"Algo5","USD/JPY","CHRIS/CME_JY1",1,6,1000000,1,FALSE);
    ContFutvsSpotCandleAlgo(11,"Algo5b","USD/JPY","CHRIS/CME_JY2",1,6,1000000,1,FALSE);
    
    ContFutvsSpotCandleAlgo(12,"Algo6","AUD/USD","CHRIS/CME_AD1",1,6,0,1,FALSE);
    ContFutvsSpotCandleAlgo(13,"Algo6b","AUD/USD","CHRIS/CME_AD2",1,6,0,1,FALSE);

    ContFutvsSpotCandleAlgo(14,"Algo7","NZD/USD","CHRIS/CME_NE1",1,6,0,1,FALSE);
    ContFutvsSpotCandleAlgo(15,"Algo7b","NZD/USD","CHRIS/CME_NE2",1,6,0,1,FALSE);

...
///----------------------------------\\\ 
///  FX G12 TOP LONG-SHORT STRATEGY  \\\ 
///----------------------------------\\\ 
///        NEXOW SYSTEMS S.L.        \\\ 
///        Author: Alex Colls        \\\ 
///         Date: April 2019         \\\ 
...
#include <NexowFunctions.h>
    ...
    /// 1. STRATEGY PARAMETERS \\\ 
        ...
        #define SECSL 20
        #define SECTP 20
        #define MAXFLOATDD 40
        #define MINFLOATDD -80
        #define MAXLEVERAGE 40
        #define MAXLEVPERCURR 20

        #define SET_PLOT FALSE
...
void run(){
    ...
    /// 6. ACCOUNT PLOTS \\\ 
        ...
        if( PLOT_ACCOUNT ){
            ...
            plot("EquityVal",Equity,1,BLACK);
            plot("MarginUsed",MarginVal,0,BLUE);

...
// chart
C void F(plot)(const char* name,var val,int type,int color);
...
C void F(assetAdd)(const char* Name,var vPrice,var vSpread,var vRollLong,var vRollShort,var vPip,var vPipCost,var vMarginCost,var vLeverage,var vLotAmount,var vCommission,const char* sSymbol);
...
C void F(assetSwitch)();  // select scrollbox asset by script
...
// new functions at the end, add to func_list, chm idx, npp.
#undef F
#undef F0
#undef F1
#undef F2
